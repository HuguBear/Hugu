      ...
      ? (
        <TouchableWithoutFeedback>
          <View>
            ...
            <RoundedButton disabled={(this.state.ssid === '')} onPress={() => { }}>
              {I18n.t('continue')}
            </RoundedButton>
    ...
    : (
      <TouchableWithoutFeedback>
        <View>
          ...
          <RoundedButton disabled={(this.state.huguSelected === '')} onPress={() => { this.props.connectBearRequest(this.state.huguSelected, this.unconnectedRowID) }}>
            {I18n.t('choose')}
          </RoundedButton>
          <RoundedButton onPress={() => { this.setWifiModalVisible(!this.state.wifiModalVisible) }}>
            {I18n.t('cancel')}
